...
WALRecord WALRecord::newCreateTableRecord(table_id_t tableID, common::TableType tableType) {
    WALRecord retVal;
...
WALRecord WALRecord::newDropTableRecord(table_id_t tableID, TableType tableType) {
    WALRecord retVal;
